...
def _apply_rotary_pos_emb_thd(
    ...
    **kwargs,
    ...
    # 2. If kwargs has offset: t is sequence parallel sharded and freqs contains max sequence length
    #    positions.
    #    -> use offset to get correct global position.
    ...
    if freqs.dim() >= 1 and freqs.size(0) == cu_seqlens[-1]:
        ...
        # CASE 2: Sequence parallel with offsets
        # Use offsets to handle some sequence split across sequence parallel ranks
